...
Examples:
    ...
    ./drawCoverage.py -f data.csv -m mobility.ns2 -p buildings.xml -r 1000
    
    # Process single file with map folder (auto-detects scenario)
    ./drawCoverage.py -f /path/to/Padova-25/b0/e0/r100/j0/cw32-1024/Fast-Broadcast/data.csv --mapfolder /path/to/maps
    
    # Batch process folder
    ./drawCoverage.py -b /path/to/basefolder --mapfolder /path/to/maps -r 1500
"""
...
def plot_coverage(csv_file_path, output_file_path, config):
    ...
    plt.plot(x_received_coords, y_received_coords, ".", 
             markersize=5, color="#32DC32", 
...
def main():
    ...
    script_config = {
        ...
        'single_output_subfolder': 'singlefileCoverage',
