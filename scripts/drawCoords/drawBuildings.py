...
Usage:
    ./drawBuildings.py <polygon_file> [output_file]
...
Examples:
    ...
    ./drawBuildings.py buildings.xml

    # Plot buildings with custom output
    ./drawBuildings.py buildings.xml my_buildings.png
"""
...
def plot_buildings(poly_file_path, output_file_path):
    ...
    # Plot buildings
    try:
        coordUtils.plotBuildings(poly_file_path)
...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: drawBuildings.py <polygon_file> [output_file]")
        print("\nArguments:")
        ...
        print("\nExamples:")
        print("  ./drawBuildings.py buildings.xml")
        print("  ./drawBuildings.py buildings.xml my_buildings.png")
        sys.exit(1)
