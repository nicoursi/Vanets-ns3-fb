...
def main():
    ...
    if len(sys.argv) <= 1:
        ...
        print_multiple_graphs.print_distance_comparison(
            contentionWindows[1],
            vehicleDistances,
            fbProtocols,
            vehicleDistances,
            distanceXLabels,
            "fb",
            "Fast Broadcast protocols",
            "vehicleDistanceComparison",
            False,
        )
        print_multiple_graphs.print_distance_comparison(
            contentionWindows[1],
        ...
        print_multiple_graphs.printCwComparison(
            contentionWindows,
            25,
            fbProtocols,
            contentionWindows,
        ...
        print_multiple_graphs.printRomanelliComparison(
            contentionWindows[1],
            25,
            allProtocols,
            allProtocols,
